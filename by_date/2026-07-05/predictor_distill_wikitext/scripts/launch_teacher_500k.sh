...
PAIRS=$REPO/MOTIVATION_EXPERIMENTS/predictor_distill_wikitext/data/text_pairs_500k.jsonl
OUT=$REPO/MOTIVATION_EXPERIMENTS/predictor_distill_wikitext/teacher_cache_500k
LOG=$REPO/MOTIVATION_EXPERIMENTS/predictor_distill_wikitext/logs/teacher_500k
