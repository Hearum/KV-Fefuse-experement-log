...
PAIRS=$REPO/MOTIVATION_EXPERIMENTS/predictor_distill_wikitext/data/text_pairs_20k.jsonl
OUT=$REPO/MOTIVATION_EXPERIMENTS/predictor_distill_wikitext/teacher_cache_20k
LOG=$REPO/MOTIVATION_EXPERIMENTS/predictor_distill_wikitext/logs/teacher_20k
mkdir -p "$OUT" "$LOG"
for gpu in 0 1 2 3 4 5 6 7; do
  start=$((gpu*2500)); end=$(((gpu+1)*2500))
