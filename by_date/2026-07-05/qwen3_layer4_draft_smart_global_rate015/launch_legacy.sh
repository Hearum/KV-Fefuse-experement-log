...
OUT_ROOT="$REPO/MOTIVATION_EXPERIMENTS/qwen3_layer4_draft_smart_global_rate015"
FIXED="$REPO/MOTIVATION_EXPERIMENTS/offline_fixed_token_selector/reflect_draft_layer4_smart_global_rate015_full/chunk_fixed_sets_npz"
API_URL=http://36.150.226.221:32355/v1
API_KEY=api_aK7mP9xQ2vL4wR8sT1yU5zC3bN6dE0fG7hI2jK4lM8nO1pQ3rS
METHODS=(draft_smart_frequency_global draft_smart_mean_score_global)
...
segments=("0 25 0" "25 50 1" "50 75 3" "75 100 4" "100 125 5" "125 150 6" "150 175 7" "175 200 0")
for item in "${segments[@]}"; do
  read -r start end gpu <<< "$item"
