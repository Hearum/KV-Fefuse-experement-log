...
from block_summary_selected import (build_block_prefix_states, block_summary_selected_attention,
                                    ...
                                    block_summary_selected_attention_fused_gqa)
...
def main():
    ...
    print("length,Q,sdpa_ms,triton_block_ms,matmul_block_ms,batched_gqa_ms,fused_triton_ms,fused_gqa_ms,sdpa_MiB,triton_MiB,matmul_MiB,batched_gqa_MiB,fused_triton_MiB,fused_gqa_MiB")
    for s in a.lengths:
        ...
        for nq in a.queries:
            ...
            fused_gqa = lambda: block_summary_selected_attention_fused_gqa(q, k, v, qpos, block_size=a.block_size, block_prefix_s=ps, block_prefix_z=pz, block_k=block_kt, block_v=block_vt)
            ...
            fgm, fgp = measure(fused_gqa, a.warmup, a.iters)
            print(f"{s},{nq},{sm:.3f},{lm:.3f},{mm:.3f},{bm:.3f},{fm:.3f},{fgm:.3f},{sp:.1f},{lp:.1f},{mp:.1f},{bp:.1f},{fp:.1f},{fgp:.1f}")
