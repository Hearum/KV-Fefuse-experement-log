...
OUT_ROOT="$REPO/MOTIVATION_EXPERIMENTS/qwen3_offline10_plus_distilled_residual_rate015_trace_after_fix"
...
run_segment() {
  ...
  mkdir -p "$out_dir" "$OUT_ROOT/logs" "$out_dir/selected"
  cd "$REPO"
  ...
  FUSIONRAG_SAVE_SELECTED_DIR="$out_dir/selected" \
