...
EXP = ROOT / "MOTIVATION_EXPERIMENTS/qwen3_offline10_plus_hs_residual_rate015"
LABEL = "offline10_hs005_epoch003"
MODEL_DIR = "Qwen3-32B/musique/FusionRAG_global_topk10_bge"
CSV_NAME = "rate_0.15_revert_rope.csv"
SEGMENTS = [(0, 50), (50, 100), (100, 150), (150, 200)]
...
def main():
    ...
    out = {
        "method": "offline10_draft_smart_frequency_global + FusionRAG-HS_hidden_scorer_residual005_epoch003",
    ...
    lines = [
        ...
        f"{out['finished_segments']} | {out['traceback']}/{out['killed']} |\n",
    ]
