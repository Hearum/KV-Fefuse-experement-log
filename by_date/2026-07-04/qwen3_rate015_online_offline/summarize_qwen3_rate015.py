...
RUNS = [
    ('online_qk_rate015', 0.15, 'FusionRAG_global_topk10_bge', 'rate_0.15_revert_rope.csv', 'online FusionRAG-QK selector at rate=0.15'),
    ('online_draft_rate015', 0.15, 'DraftModel_global_topk10_bge', 'rate_0.15_draft_Qwen2.5-3B-Instruct_revert_rope.csv', 'online draft-model selector at rate=0.15'),
    ('offline_hybrid70_rate015', 0.15, 'FusionRAG_global_topk10_bge', 'rate_0.15_revert_rope.csv', 'offline fixed set, hybrid draft70/qk30 score per chunk, rate=0.15'),
]
...
def summarize(label, rate, subdir, filename, note):
    ...
    ans = {
        ...
        'sub_correct': sub_correct, 'sub_total': sub_total,
        ...
        'missing_csv': len(missing), 'note': note,
    }
...
def main():
    ...
    lines = ['# Qwen3-32B Rate=0.15 Online/Offline Selector Experiment\n\n']
