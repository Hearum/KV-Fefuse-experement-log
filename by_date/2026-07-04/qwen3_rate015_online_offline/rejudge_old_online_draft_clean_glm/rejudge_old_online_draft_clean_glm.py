...
OUT=ROOT/'MOTIVATION_EXPERIMENTS/qwen3_rate015_online_offline/rejudge_old_online_draft_clean_glm'
PAT=str(OLD/'seg_*/Qwen3-32B/musique/DraftModel_global_topk10_bge/rate_0.15_draft_Qwen2.5-3B-Instruct_revert_rope.csv')
CACHE=OUT/'judge_cache_old_draft_rate015_clean_glm52.jsonl'
OUTCSV=OUT/'old_online_draft_rate015_clean_rejudged_glm52.csv'
