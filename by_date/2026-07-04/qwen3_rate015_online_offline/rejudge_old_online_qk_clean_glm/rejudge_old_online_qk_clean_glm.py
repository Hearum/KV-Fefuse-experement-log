...
OLD=ROOT/'MOTIVATION_EXPERIMENTS/qwen3_rate015_online_offline/online_qk_rate015'
OUT=ROOT/'MOTIVATION_EXPERIMENTS/qwen3_rate015_online_offline/rejudge_old_online_qk_clean_glm'
PAT=str(OLD/'seg_*/Qwen3-32B/musique/FusionRAG_global_topk10_bge/rate_0.15_revert_rope.csv')
CACHE=OUT/'judge_cache_old_qk_rate015_clean_glm52.jsonl'
OUTCSV=OUT/'old_online_qk_rate015_clean_rejudged_glm52.csv'
...
def clean_pred(s):
    text=(s or '').strip()
    # Remove Qwen3 thinking wrapper and leading answer label before rejudge.
