...
EXP=Path('/raid/home/hming/FusionRAG-pca-analysis/MOTIVATION_EXPERIMENTS/qwen3_offline_hybrid70_draftpath_rate015')
SEG=[(0,25),(25,50),(50,75),(75,100),(100,125),(125,150),(150,175),(175,200)]
def mean(xs): return sum(xs)/len(xs) if xs else 0.0
rows=OrderedDict(); text=''; missing=0
for s,e in SEG:
 p=EXP/f'seg_{s}_{e}/Qwen3-32B/musique/DraftModel_global_topk10_bge/rate_0.15_draft_Qwen2.5-3B-Instruct_revert_rope.csv'
