...
- FusionRAG TTFT compute mean: `0.359761s`, p50: `0.353926s`, p95: `0.439515s`
- FusionRAG TTFT wall mean: `0.413408s`, p50: `0.406095s`, p95: `0.510190s`
...
- KV load/storage mean: `0.023852s`
- Selection mean: `0.101925s`
- Selection score forward mean: `0.101132s`
- Sparse recompute + query prefill mean: `0.233983s`
- Selected doc tokens mean: `1432.95`
- Reprocess prefill tokens mean: `1460.14`
- Full prompt tokens mean: `2267.12`

## Files

- detail CSV: `/raid/home/hming/FusionRAG-pca-analysis/MOTIVATION_EXPERIMENTS/online_ttft_profile_clean_rate_sweep_v2/rate_0.99/clean_online_ttft_topk10_rate0.99_n120.csv`
- summary JSON: `/raid/home/hming/FusionRAG-pca-analysis/MOTIVATION_EXPERIMENTS/online_ttft_profile_clean_rate_sweep_v2/rate_0.99/clean_online_ttft_topk10_rate0.99_n120_summary.json`
