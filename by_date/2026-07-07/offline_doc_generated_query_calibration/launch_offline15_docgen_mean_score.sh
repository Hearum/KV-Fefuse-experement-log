...
FIXED="$EXP/docgen_chunk_draft_mean_score_full/rate_0p15/chunk_fixed_sets_npz"
METHOD=docgen_draft_smart_mean_score_global
RUN=offline15_docgen_mean_score_only
...
run_segment() {
  ...
  FUSIONRAG_RESIDUAL_ONLINE_RATE=0.0 FUSIONRAG_RESIDUAL_ONLINE_METHOD=DraftModel \
