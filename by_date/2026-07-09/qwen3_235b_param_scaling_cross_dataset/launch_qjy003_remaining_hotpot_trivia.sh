...
LOG=$EXP/logs/qjy003_remaining_hotpot_trivia.log
...
echo "[$(date '+%F %T')] START qjy003 remaining hotpot/trivia queue" | tee -a "$LOG"
...
echo "[$(date '+%F %T')] FINISHED qjy003 remaining hotpot/trivia queue" | tee -a "$LOG"
