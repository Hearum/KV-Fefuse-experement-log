...
| metric | value |
|---|---:|
| jaccard_all_mean | 0.7452 |
| jaccard_related_related_mean | 0.7579 |
| jaccard_unrelated_unrelated_mean | 0.7469 |
| jaccard_related_unrelated_mean | 0.7343 |
| all_query_intersection_ratio | 0.7223 |
| related_intersection_ratio | 0.8271 |
| unrelated_intersection_ratio | 0.7262 |
| never_selected_ratio | 0.6494 |
| always_selected_ratio | 0.1081 |
| selected_ge_50pct_ratio | 0.1336 |
| selected_ge_80pct_ratio | 0.1202 |
