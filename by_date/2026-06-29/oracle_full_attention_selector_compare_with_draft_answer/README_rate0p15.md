...
| fusionrag_qk | 109 | 0.1864 | 0.1186 | 0.1172 | 0.3151 | 0.2205 | 0.2092 | 0.0272s |
| oracle_full_attention | 109 | 0.4306 | 0.8150 | 1.0000 | 1.0000 | 0.0000 | 1.0000 | 0.3019s |
...
| selector | n | F1 | EM |
|---|---:|---:|---:|
| draft_selected_set | 109 | 0.5383 | 0.2202 |
| fusionrag_qk | 109 | 0.4764 | 0.2110 |
| oracle_full_attention | 109 | 0.4394 | 0.1927 |

## 文件

- selector detail: `MOTIVATION_EXPERIMENTS/oracle_full_attention_selector_compare_with_draft_answer/selector_detail_rate0p15.csv`
- answer detail: `MOTIVATION_EXPERIMENTS/oracle_full_attention_selector_compare_with_draft_answer/answer_detail_rate0p15.csv`
