...
def main():
    ...
    torch.save({"state_dict":best[2],"coefficient_std":train_std.half(),"basis":basis_model,"config":{"prefix_dim":32,"rank":64}},RESULTS/"shared_mlp_predictor_balanced.pt")
    (RESULTS/"shared_mlp_predictor_balanced.json").write_text(json.dumps(result,indent=2)+"\n"); print(json.dumps(result,indent=2))
