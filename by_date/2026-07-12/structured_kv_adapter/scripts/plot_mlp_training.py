...
data = json.loads((root / "results/shared_mlp_predictor.json").read_text())
...
ax.set(xlabel="Epoch", ylabel="Normalized coefficient MSE", title="Shared MLP training curve")
ax.grid(alpha=0.25); ax.legend(); fig.tight_layout()
fig.savefig(root / "figures/shared_mlp_training_curve.png", dpi=180)
