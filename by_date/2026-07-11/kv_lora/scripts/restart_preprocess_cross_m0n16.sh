...
OMP_NUM_THREADS=4 MKL_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=4 nohup /mnt/qjhs-sh-lab-01/wjh/FusionRAG/.venv/bin/python test_fusionrag_reflect_preprocess_exp.py \
 ...
 > "$out/logs/preprocess_static_m0n16.log" 2>&1 < /dev/null &
echo $! > "$out/logs/preprocess_static_m0n16.pid"
